...
#
# Author:      TheBest_F-22!.  ( GitHub.com/JoaoPCunha )
...
#
#
#   Do EDIT this next "$installPath" variable definition to the Path of Your "MSys" (or "Variant"/similar)
...
$files = (Get-ChildItem "$installPath\usr\bin\*.exe").FullName

Write-Host ("
Executing the Forced `"OFF`" State for the 
 `"Mandatory ASLR`" Mitigation on " + $files.Count + " `".exe`" files...  
