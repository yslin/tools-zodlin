...
function! s:KeyMap.Create(options)
    ...
    echo "newKeyMap.key" . newKeyMap.key
    let newKeyMap.quickhelpText = opts['quickhelpText']
    echo "newKeyMap.quickhelpText" . newKeyMap.quickhelpText
    let newKeyMap.callback = opts['callback']
    echo "newKeyMap.callback" . newKeyMap.callback
    let newKeyMap.scope = opts['scope']
    echo "newKeyMap.scope" . newKeyMap.scope
...
call g:GlobalKeyMap.Invoke("foo")

echo type(g:GlobalKeyMap)
