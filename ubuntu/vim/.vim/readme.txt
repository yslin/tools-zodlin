...
pathogen.vim	for setting plugin runtime path
...
Not built-in vim.
The lang directory is for plugin about programming language tools.
==============================================================================
4. visual						*visual*

Not built-in vim.
The visual directory is for plugin about diagram or presenting data.
